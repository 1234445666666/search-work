...
const rows = [
  ...
  { label: "График", key: "schedule" },
  { label: "Опыт", key: "experience" },
  { label: "Занятость", key: "employment" },
];
...
export default function Compare() {
  ...
  function calcStore(vacancy: IVacancies) {
    ...
    if (vacancy.experience === "Без опыта") {
      result += 1;
    }
    if (vacancy.employment === "Удалённо") {
      result += 1;
    }
    if (vacancy.schedule === "Гибкий" || vacancy.schedule === "2/2") {
      result += 1;
    }
    return result;
  }
    ...
    <div className={styles.page}>
      ...
      <div className={styles.gridWrapper}>
        <div className={styles.grid}>
          ...
          <div
            className={`${styles.rowValue} ${a.hasNdfl ? styles.winner : ""}`}
          >
          ...
          <div
            className={`${styles.rowValue} ${b.hasNdfl ? styles.winner : ""}`}
          >
